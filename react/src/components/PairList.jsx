...
import { calculatePriceWithDecimals, genRaise, getBlockHeight, getPriceByBlockHeight, getData, tarDecimals, isWellFormattedAddress } from '../lib/api';
...
const PairItem = (props) => {
  ...
  React.useEffect(() => {
    const init = async () => {
      ...
      const logoTx = props.pairInfo.logo;
      setLogo(await getData(logoTx));
